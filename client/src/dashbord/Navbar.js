    ...
    <div className="navbar">
      ...
      <nav>
        <ul className="nav-links">
          {/* <li style={{paddingRight:"200px"}}></li> */}
          {/* <li><Link to="/myfarms">My Farms</Link></li> */}
          ...
          {/* <li><Link to='/transaction'>My Transaction</Link></li> */}
        </ul>
      </nav>
      {/* <button className="logout-btn" onClick={get}>Profile</button>
